...
<div class="p-4">
          ...
          <div class="max-w-6xl bg-[#232323] p-10 rounded-2xl mx-auto text-white">
             ...
             {/* GRID: Items Left, Billing Right */}
<div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-10">

  {/* LEFT — ALL ORDER ITEMS */}
  ...
  <div className="space-y-6">
    ...
    <div className="bg-[#202020] border border-[#232323] rounded-md p-6">
      ...
      <div className="mt-6 space-y-3">
        <button
          onClick={() => showCancelConfirm(or.order.orderId)}
          className="w-full text-sm px-4 py-2 bg-green-800 text-white rounded-md hover:bg-green-700"
        >
          Cancel Order
        </button>

        <button
          className="w-full text-sm px-4 py-2 bg-transparent text-white border border-gray-300 rounded-md hover:bg-gray-700"
        >
          Continue Shopping
        </button>
      </div>
